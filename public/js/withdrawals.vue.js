...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.isEmpty = function (obj) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	props: ["Id", "Enviroment", "WithdrawalsSummaryRoute", "WithDrawRequestRoute", "CreateBankAccountRoute", "FinancialEntryRoute", "FinanceTypes", "Holder", "Ledger", "Balance", "BankAccounts", "BankList", "AccountTypes", "WithDrawSettings", "currencySymbol"],
	data: function data() {
		return {
			id: "",
	...
	methods: {
		...
		totalize: function totalize(balance) {
			var totalizer = 0;
		...
		getWithdrawalsSummary: function getWithdrawalsSummary() {
			var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

			// TODO getWithdrawalsSummary
			console.log("aqui");
		},
		downloadFinancialSummary: function downloadFinancialSummary() {
			// TODO downloadFinancialSummary
			console.log("download");
		},
		ModalNewBankClosed: function ModalNewBankClosed(newBankAccount) {
...
var render = function() {
  ...
  return _c("div", [
      ...
      _c("div", { staticClass: "card card-outline-info" }, [
        _c("div", { staticClass: "card-header" }, [
          _c("h4", { staticClass: "m-b-0 text-white" }, [
            _vm._v(_vm._s(_vm.trans("finance.withdrawals_report")))
          ])
        ]),
        _vm._v(" "),
                  ...
                  [
                    _c("div", { staticClass: "box-body" }, [
                      _c("div", { staticClass: "row" }, [
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    attrs: {
                                      ...
                                      maxlenght: "255",
                                      "auto-focus": "",
                                      placeholder: _vm.trans("finance.name")
                                    }
                                  })
                                ])
                              ])
                                ...
                                _c("div", { staticClass: "form-group" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    attrs: {
                                      ...
                                      maxlenght: "255",
                                      "auto-focus": "",
                                      placeholder: _vm.trans("finance.bank")
                                    }
                                  })
                                ])
                              ])
                        ...
                        _c("div", { staticClass: "col-md-3" }, [
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", { attrs: { for: "giveName" } }, [
                              _vm._v(_vm._s(_vm.trans("finance.status")))
                            ]),
                            _vm._v(" "),
                            _c(
                              "select",
                              ...
                              [
                                ...
                                _c("option", { attrs: { value: "1" } }, [
                                  _vm._v(
                                    _vm._s(
                                      _vm.trans("finance.withdrawal_requested")
                                    )
                                  )
                                ]),
                                _vm._v(" "),
                                _c("option", { attrs: { value: "2" } }, [
                                  _vm._v(
                                    _vm._s(_vm.trans("finance.withdrawal_made"))
                                  )
                                ])
                              ]
                            )
                        ...
                        _c("div", { staticClass: "col-md-3" }, [
                          _c("div", { staticClass: "form-group" }, [
                            _c("label", { attrs: { for: "giveName" } }, [
                              _vm._v(_vm._s(_vm.trans("finance.receipt")))
                            ]),
                            _vm._v(" "),
                            _c(
                              "select",
                              {
                                ...
                                on: {
                                  change: function($event) {
                                    ...
                                    _vm.receipt = $event.target.multiple
                                      ? $$selectedVal
                                      : $$selectedVal[0]
                                  }
                                }
                              ...
                              [
                                ...
                                _vm._v(" "),
                                _c("option", { attrs: { value: "1" } }, [
                                  _vm._v(_vm._s(_vm.trans("finance.no")))
                                ]),
                                _vm._v(" "),
                                _c("option", { attrs: { value: "2" } }, [
                                  _vm._v(_vm._s(_vm.trans("finance.yes")))
                                ])
                              ]
                            )
                          ])
                      ...
                      _c("div", { staticClass: "box-footer pull-right" }, [
                        _c(
                          "button",
                          {
                            staticClass: "btn btn-info right",
                            attrs: { type: "button" },
                            on: { click: _vm.downloadFinancialSummary }
                          },
                          [
                            ...
                            _vm._v(
                              " " +
                                _vm._s(
                                  _vm.trans("finance.download_withdrawals")
                                )
                            )
                          ]
                        ),
                        ...
                        _c(
                          "button",
                          {
                            ...
                            attrs: { type: "button", value: "Filter_Data" },
                            on: { click: _vm.getWithdrawalsSummary }
                          },
                          [
                            _c("i", { staticClass: "fa fa-search" }),
                            _vm._v(" " + _vm._s(_vm.trans("finance.search")))
                          ]
                        )
                      ]),
                      _vm._v(" "),
                                ...
                                directives: [
                                  {
                                    ...
                                    rawName: "v-show",
                                    value:
                                      _vm.with_draw_settings
                                        .with_draw_enabled == true,
                                    expression:
                                      "with_draw_settings.with_draw_enabled == true"
                                  }
                                ],
                                staticClass: "btn btn-info",
                                attrs: { type: "button" },
                                on: { click: _vm.showModalRequestWithdraw }
                              },
                              [
                                ...
                                _vm._v(
                                  " " +
                                    _vm._s(
                                      _vm.trans("finance.request_withdraw")
                                    ) +
                                    "\n                                            "
                                )
                              ]
    ...
    _vm._v(" "),
    !_vm.isEmpty(_vm.balance.detailed_balance)
      ? _c("div", { staticClass: "col-lg-12" }, [
          _c(
            "div",
            { staticClass: "card" },
            [
              _c("div", { staticClass: "card-block" }, [
                _c("div", { staticClass: "card-block" }, [
                  _c(
                    ...
                    [
                      _c("tr", [
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.id")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.name")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.email")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.bank")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.agency")))]),
                        _vm._v(" "),
                        _c("th", [
                          _vm._v(_vm._s(_vm.trans("finance.account")))
                        ]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.cpf")))]),
                        _vm._v(" "),
                        _c("th", [_vm._v(_vm._s(_vm.trans("finance.status")))]),
                        _vm._v(" "),
                        _c("th", [
                          _vm._v(_vm._s(_vm.trans("finance.receipt")))
                        ]),
                        _vm._v(" "),
                        _c("th", [
                          _vm._v(_vm._s(_vm.trans("finance.finance_date")))
                        ]),
                        _vm._v(" "),
                        _c("th", [
                          _vm._v(_vm._s(_vm.trans("finance.finance_time")))
                        ]),
                        _vm._v(" "),
                        _c("th", [
                          _vm._v(_vm._s(_vm.trans("finance.finance_value")))
                        ])
                      ]),
                      _vm._v(" "),
                      _vm._l(_vm.balance.withdrawals_list, function(entry) {
                        return _c(
                          "tr",
                          { key: entry.id, attrs: { total: "0" } },
                          [
                            ...
                            _c("td", [
                              _vm._v(
                                _vm._s(
                                  (entry.provider_first_name ||
                                    entry.user_first_name) +
                                    " " +
                                    (entry.provider_last_name ||
                            ...
                            _c("td", [
                              _vm._v(
                                _vm._s(entry.provider_email || entry.user_email)
                              )
                            ]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.bank))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.agency))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.account))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.document))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.status))]),
                            _vm._v(" "),
                            _c("td", [_vm._v(_vm._s(entry.receipt))]),
                            _vm._v(" "),
                            _c("td", [
                              new Date(entry.compensation_date)
                                .toLocaleString()
                                .split(" ")[0] != "31/12/1969"
                                ? _c("p", [
                                    _vm._v(
              ...
              _vm._v(" "),
              _c("pagination", {
                attrs: { data: _vm.balance.detailed_balance },
                on: { "pagination-change-page": _vm.getWithdrawalsSummary }
              })
            ],
            1
          )
