...
// to run test: sail artisan test --filter LibWithdrawalsLanguageSpanishTest
class LibWithdrawalsLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/withdrawals/src/resources/lang';
