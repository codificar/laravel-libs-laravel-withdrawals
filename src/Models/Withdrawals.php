...
class Withdrawals extends Eloquent
{
    ...
    public static function getWithdrawalsSummary($ledgerId = null, $enviroment)
    {
        ...
        $withdrawalsSummary = Finance::select('finance.id as id', 'finance.value as value', 'finance.compensation_date as date', 'bank.name as bank', 'ledger_bank_account.account as bankAccount')
