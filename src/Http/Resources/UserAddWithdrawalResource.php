...
/**
 * Class UserAddWithdrawalResource
 *
 * @package MotoboyApp
 *
 *
 * @OA\Schema(
 *         schema="UserAddWithdrawalResource",
 *         type="object",
 *         description="Adiciona um saque para o usuário",
 *         title="Withdrawals Details Resource",
 *        allOf={
 *           @OA\Schema(ref="#/components/schemas/UserAddWithdrawalResource"),
 *           @OA\Schema(
 ...
 * )
 */
class UserAddWithdrawalResource extends JsonResource {
